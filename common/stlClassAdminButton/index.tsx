...
const StlClassButton = () => {
  ...
  const download = async() => {
    if (management.stlClassLoading) {
      setLoading(true)

      await downLoadStlReport('CLASS_ADMIN');
      dispatch({
    ...
    <div className="download-report">
      <button
        ...
        className={`download-report__btn ${
          management.stlClassLoading ? "change-color" : ""
        }`}
      >
        Download STL Report
        {loading && (
